define([], function () {
	var typeData = [
		{type: '1', refer: 'kh', title: '新开户', explain: '我是新入市投资者，还没有股东账户'},
		{type: '3', refer: 'zh', title: '转户', explain: '我已有股东账户，已撤销指定交易和完成转托管'},
		{type: '5', refer: 'lch', title: '理财户', explain: '无论有没有在其他券商开立股东账户，都可开立理财户'}
	];
